...
import { Menu, X, Car, Factory, Building2, ChevronDown, ChevronUp } from 'lucide-react'
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 z-50 h-full w-[85%] max-w-sm bg-white shadow-2xl lg:hidden overflow-y-auto"
            >
